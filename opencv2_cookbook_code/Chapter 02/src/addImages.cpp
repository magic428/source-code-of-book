...
int main()
{
	...
	image1= cv::imread("../../../3241OS_images/images/boldt.jpg");
	image2= cv::imread("../../../3241OS_images/images/rain.jpg");
	if (!image1.data)
		return 0; 
	if (!image2.data)
		return 0; 
	...
	image2= cv::imread("../../../3241OS_images/images/rain.jpg",0);
	...
	cv::Mat logo= cv::imread("../../../3241OS_images/images/logo.bmp");
	...
	// read images
	image= cv::imread("../../../3241OS_images/images/boldt.jpg");
	logo= cv::imread("../../../3241OS_images/images/logo.bmp");

	// define ROI
	imageROI= image(cv::Rect(385,270,logo.cols,logo.rows));

	// load the mask (must be gray-level)
	cv::Mat mask= cv::imread("../../../3241OS_images/images/logo.bmp",0);
	...
	// read images
	logo= cv::imread("../../../3241OS_images/images/logo.bmp",0);
	image1= cv::imread("../../../3241OS_images/images/boldt.jpg");
